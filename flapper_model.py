...
def rate_controller(onboard, i):
    gx, gy, gz = onboard.loc[i, ["gyro.x", "gyro.y", "gyro.z"]].to_numpy().T
    pitchrate_sp, rollrate_sp, yawrate_sp = (
        onboard.loc[i, ["controller.rollRate", "controller.pitchRate","controller.yawRate"]]
...
if __name__ == "__main__":
    ...
    for i in range(len(onboard_data)):
        rate_controller(onboard_data, i, 1  / freq_attitude_rate)
